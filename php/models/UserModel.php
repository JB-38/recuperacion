...
class UserModel extends Database
{
    ...
    {
        return $this->select("SELECT * FROM usuarios WHERE (id = '" . $id . "' || usuario = '" . $id . "') ORDER BY id");
    }
    ...
    public function setUsers($data)
    {
        ...
        return $this->insert("INSERT INTO usuarios (usuario, telefono, direccion, nombre, clave, apellido) VALUES ('". $data["usuario"] . "', '" . $data["telefono"] . "', '" . $data["direccion"] ."' ,'" . $data["nombre"] . "' ,'". sha1($data['clave']) ."', '". $data['apellido'] ."')");
    }
    ...
    public function loginUser($identifier, $clave)
    {
        ...
        echo "SELECT * FROM usuarios WHERE usuario = '". $identifier ."' AND clave = '". sha1($clave) ."' ORDER BY id";

        $user = $this->select("SELECT * FROM usuarios WHERE usuario = '". $identifier ."' AND clave = '". sha1($clave) ."' ORDER BY id");
